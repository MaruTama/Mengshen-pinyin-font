...
class HanziGlyphGenerator:
    ...
    def __init__(
        ...
        # External pronunciation glyphs (set externally)
        self._pronunciation_glyphs_for_hanzi: Optional[PinyinGlyphDict] = None

    def set_pronunciation_glyphs_for_hanzi(
        self, pronunciation_glyphs: PinyinGlyphDict
    ) -> None:
        """Set pronunciation glyphs for hanzi generation."""
        self._pronunciation_glyphs_for_hanzi = pronunciation_glyphs
    ...
    def _create_hanzi_with_pinyin_glyph(
        ...
        # Use external pronunciation glyphs if available
        if self._pronunciation_glyphs_for_hanzi is not None:
            pronunciation_glyphs = self._pronunciation_glyphs_for_hanzi
        else:
            # Only use pinyin_generator
            try:
...
class GlyphManager:
    ...
    def initialize(
        ...
        # Use refactored pinyin generator
    ...
    def generate_hanzi_glyphs(self) -> None:
        ...
        self.hanzi_generator.set_pronunciation_glyphs_for_hanzi(
            self._pronunciation_glyphs
        )
