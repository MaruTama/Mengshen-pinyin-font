    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            return {
                ...
                "oldest_entry_age": (
                    datetime.now() - oldest_entry.created_at if oldest_entry else None
                ),
                "newest_entry_age": (
                    datetime.now() - newest_entry.created_at if newest_entry else None
                ),
            }
...
class SmartCache:
    ...
    def cached_with_file_deps(
        self, dependencies: list[Union[str, Path]], ttl: Optional[timedelta] = None
    ):
