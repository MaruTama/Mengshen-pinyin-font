...
class CharacterDataManager:
    ...
    def iter_characters_by_classifier(self, classifier: CharacterClassifier) -> Iterator[CharacterInfo]:
    ...
    def get_statistics(self) -> dict:
        ...
        return {
            ...
            'homograph_percentage': round((multiple_count / total) * 100, 2) if total > 0 else 0
        }
