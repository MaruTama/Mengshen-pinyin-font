...
3. Create the integrated unicode table(i.e. [merged-mapping-table.txt](https://github.com/MaruTama/Mengshen-pinyin-font/blob/master/outputs/merged-mapping-table.txt)) that traditional and simplified Chinese
4. Overwrite the integrated Unicode table (i.e. [merged-mapping-table.txt](https://github.com/MaruTama/Mengshen-pinyin-font/blob/master/outputs/merged-mapping-table.txt)) with [overwrite.txt]()
...
```
outputs
   └── merged-mapping-table.txt -> integrated unicode table of traditional and simplified chinese unicode tables(Overwrite.txt was reflected)
```
...
└── overwrite.txt                    -> Table for modification. Overwrite merged-mapping-table.txt. (Editable)
```