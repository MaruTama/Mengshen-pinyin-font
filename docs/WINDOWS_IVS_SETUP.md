# Windows IVS Setup - Using IME Pad for Ideographic Variant Selector

## Overview

This guide explains how to use Ideographic Variant Selector (IVS) with the Mengshen pinyin font on Windows using IME Pad. IVS allows you to manually switch between different pinyin readings for homograph characters (多音字).
