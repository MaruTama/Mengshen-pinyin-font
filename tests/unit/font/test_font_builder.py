...
from refactored.font.font_builder import ExternalToolInterface, FontBuilder
...
class TestFontBuilder:
    ...
    def test_initialize_managers(self):
        ...
        with (
            ...
            # Verify cmap table was set
            mock_set_cmap.assert_called_once_with(mock_font_data["cmap"])
