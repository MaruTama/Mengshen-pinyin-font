...
class TestFontBuilder:
    ...
    #     """Test get_build_statistics functionality (method commented out)."""
    #     with patch("refactored.tables.cmap_manager.CmapTableManager.from_path"):
    #         builder = FontBuilder(
    #             font_type=FontType.HAN_SERIF,
    #             template_main_path=Path("/mock/template_main.json"),
...
class TestFontBuilderIntegration:
    ...
    #     """Test FontBuilder error recovery mechanisms (method commented out)."""
    #     # get_build_statistics method is commented out in FontBuilder
    #     pass
