...
- [duoyinzi_pattern_one.txt](../outputs/duoyinzi_pattern_one.txt) の 1~n の並びは、[merged-mapping-table.txt](../outputs/merged-mapping-table.txt) に従う。1 が標準的な読み. ss01 と合わせる  
    ```
